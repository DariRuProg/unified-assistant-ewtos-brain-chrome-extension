// DOM-Element-Referenzen (geteilt). ewtos.com
export const statusDot = document.getElementById("status-dot");
export const navSidebar = document.getElementById("nav-sidebar");
export const navSidebarMain = document.getElementById("nav-sidebar-main");
export const viewCrumb = document.getElementById("view-crumb");
export const toolSearch = document.getElementById("tool-search");
export const toggleFavbarBtn = document.getElementById("toggle-favbar");
export const content = document.getElementById("content");
export const openOptions = document.getElementById("open-options");
