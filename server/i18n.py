...
_MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        # Blueprint metadata (built-in catalog — shown in options UI)
        "bp.kontext-base.name": "Context Profile + PARA (Base)",
        "bp.kontext-base.desc": "Personal Second Brain: a context profile (About me, Audience, Offering, Writing style, Branding) as the central reference layer + PARA buckets. Default base for every vault — the AI knows who you are. Includes the Obsidian skills.",
        "bp.kontext-base.when": "Default for every vault: the AI knows you (context profile), with PARA structure, page templates, skills and maintenance commands.",
        "bp.karpathy-para-base.name": "Karpathy Farming (Knowledge Pipeline)",
        "bp.karpathy-para-base.desc": "Self-feeding wiki à la Karpathy/Bonanno: extends the context profile and adds the farming pipeline (raw/ → wiki/resources with creators/videos/playlists). For anyone systematically moving knowledge from sources (YouTube, articles) into the wiki.",
        "bp.karpathy-para-base.when": "When you systematically move knowledge from sources (YouTube, articles) into the wiki — video/creator/playlist templates, raw/ folder and the commands /ingest /query /farm.",
        "bp.researcher.name": "Researcher",
        "bp.researcher.desc": "Researcher setup: extends karpathy-para-base, adds topics/papers/questions structures plus two .base views.",
        "bp.researcher.when": "For research: dedicated structures for topics, papers and questions plus two table views (.base). Builds on the farming module.",
    ...
    "de": {
        ...
        # Blueprint-Metadaten (Built-in-Katalog — in der Options-UI angezeigt)
        "bp.kontext-base.name": "Kontext-Profil + PARA (Basis)",
        "bp.kontext-base.desc": "Persönliches Zweites Gehirn: Kontext-Profil (Über mich, Zielgruppe, Angebot, Schreibstil, Branding) als zentrale Referenzschicht + PARA-Buckets. Standard-Basis für jeden Vault — die KI weiß, wer du bist. Bringt die Obsidian-Skills mit.",
        "bp.kontext-base.when": "Standard für jeden Vault: die KI kennt dich (Kontext-Profil), du hast PARA-Struktur, Seiten-Vorlagen, Skills und Wartungs-Commands.",
        "bp.karpathy-para-base.name": "Karpathy-Farming (Wissens-Pipeline)",
        "bp.karpathy-para-base.desc": "Self-Feeding Wiki nach Karpathy/Bonanno: erbt das Kontext-Profil und ergänzt die Farming-Pipeline (raw/ → wiki/resources mit Creators/Videos/Playlists). Für alle, die Wissen aus Quellen (YouTube, Artikel) systematisch ins Wiki überführen.",
        "bp.karpathy-para-base.when": "Wenn du Wissen aus Quellen (YouTube, Artikel) systematisch ins Wiki überführst — Video/Creator/Playlist-Vorlagen, raw/-Ordner und die Commands /ingest /query /farm.",
        "bp.researcher.name": "Researcher",
        "bp.researcher.desc": "Researcher-Setup: erbt karpathy-para-base, fügt Themen/Papers/Fragen-Strukturen plus zwei .base-Views.",
        "bp.researcher.when": "Für Forschung: eigene Strukturen für Themen, Papers und Fragen plus zwei Tabellen-Ansichten (.base). Baut auf dem Farming-Modul auf.",
